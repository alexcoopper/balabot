...
export class AiService {
    ...
    async generateDailyMessage(): Promise<string> {
        const prompt = `Твоя роль - прислати повідомлення на кожен день у груповий чат телеграм. Щось типу "а я ще тут, не забувайте про мене."
        Повідомлення має бути 18+, з пошлістю, нахабством і гумором. Має бути дежу жорсткий гумор!. Він має бути не девше ніж 1 речення! Без додаткових коментарів чи пояснень.`;
    ...
    async generateRandomMessage(messageText: string): Promise<string> {
        const prompt = `Згенеруй повідомлення, яке якось пов'язано з попереднім повідомленням.
        Попереднє повідомлення: ${messageText}.
        Це відбувається кожен вечір вівторка. Повідомлення має бути 18+, з пошлістю, нахабством і гумором. Має бути дежу жорсткий гумор!. 
